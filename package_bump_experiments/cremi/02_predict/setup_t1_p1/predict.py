...
subprocess.run(["python", predict_config["blockwise"], f"{os.path.abspath('predict_config.ini')}", f"{os.path.abspath('worker_config.ini')}", f"{os.path.abspath('data_config.ini')}"], check=True)
