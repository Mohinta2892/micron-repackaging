...
def create_network(input_shape, 
    ...
    print("gt_soft_mask.get_shape", gt_soft_mask.get_shape().as_list())
    print("soft_mask.get_shape", soft_mask.get_shape().as_list())
    print(list(output_shape))
    print(list(output_shape_batched))
    print("reshape", tf.reshape(gt_soft_mask, [1] + gt_soft_mask.get_shape().as_list() + [1]))
    print(nms_window)
    ...
    print(gt_maxima, gt_reduced_maxima)
