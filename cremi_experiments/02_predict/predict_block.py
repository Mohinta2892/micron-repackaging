...
def predict(
    ...
    pipeline += Predict(os.path.join(train_setup_dir,
                        ...
                        graph='predict_net.meta', ## spawns :21073MiB on my local RTX 3090 with 79,808,808 as input
